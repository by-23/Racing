...
namespace AYellowpaper.Editor
{
    internal static class InterfaceReferenceUtility
    {
        ...
        private static bool IsAssignedAndHasWrongInterface(Object obj, InterfaceObjectArguments args) => obj != null && !args.InterfaceType.IsAssignableFrom(obj.GetType());

        private static bool CanAssign(Object[] objects, InterfaceObjectArguments args, bool lookIntoGameObject = false) => objects.All(obj => CanAssign(obj, args, lookIntoGameObject));
